...
def base_model(input_shape):
    ...
    w_l = Bidirectional(LSTM(400,return_sequences='True', dropout=0.6), merge_mode = 'sum')(w_embedding)
    c_l = Bidirectional(LSTM(400,return_sequences='True', dropout=0.6), merge_mode = 'sum')(c_embedding)
